...
#define CS_PIN     19 // CS or SS
#define SPEED_TIME 35 // Speed of the transition
#define PAUSE_TIME  0
#define MAX_MESG   20
...
char *mon2str(uint8_t mon, char *psz, uint8_t len)
{
  ...
  {
    F("Enero"), F("Febrero"), F("Marzo"), F("Abril"),
    F("Mayo"), F("Junio"), F("Julio"), F("Agosto"),
    F("Septiembre"), F("Octubre"), F("Noviembre"), F("Diciembre")
  };
...
char *dow2str(uint8_t code, char *psz, uint8_t len)
{
  static const __FlashStringHelper* str[] =
  {
    F("Domingo"), F("Lunes"), F("Martes"),
    F("Miercoles"), F("Jueves"), F("Viernes"),
    F("Sabado")
  };
...
void setup(void)
{
  ...
  P.setInvert(false);
   ...
   P.setIntensity(5); // set the brightness of the LED matrix display (from 0 to 15)
